...
When creating a **new** skill from scratch, always create the skill directory at:
...
Create the skill at `.agents/skills/<skill-name>/`:
...
```bash
python -m scripts.package_skill .agents/skills/<skill-name>
```
