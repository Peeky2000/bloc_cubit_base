...
mixin SLIPageRouteTransitionMixin<T> on PageRoute<T> {
...
Cannot read the previousTitle for a route that has not yet been installed''',
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    return (nextRoute is SLIPageRouteTransitionMixin &&
  ...
  static Widget buildPageTransitions<T>(
    ...
    final route = rawRoute as SLIPageRoute<T>;
    final linearTransition = isPopGestureInProgress(route);
    final finalCurve = route.curve ?? defaultTransitionCurve;
    ...
    if (route.fullscreenDialog && route.transition == null) {
      ...
      switch (route.transition ?? SLIRouting.defaultTransition) {
        ...
        default:
          if (route.customTransition != null) {
            return route.customTransition!.buildTransition(context, route.curve,
